...
CREATE TABLE IF NOT EXISTS imagenes_publicacion (
  ...
  descripcion      TEXT,
  imagen           TEXT, -- reemplazado BYTEA por TEXT (para rutas de imagen)
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'chk_cantidad_positive'
  ) THEN
...
(8, 'Casita de juguetes', 'De Matel', 60, 'styless/img/producto8.webp', 4),
(9, 'Sapo Toto', 'Máxima diversión', 500.00, 'styless/img/producto9.jpg', 1),
(10, 'Collar Deadpool 3', 'Collares de la película Deadpool 3 en forma de corazón', 500.00, 'styless/img/producto10.webp', 1);
...
(6,  'Ana Pérez','ana.perez@example.com','usuario', '+59891234567','Calle Falsa 123, Montevideo, Uruguay','hash6','1995-04-02'),
(7,  'Martín López','martin.lopez@example.com','usuario', '+59890123456','Rbla. República 456, Montevideo, Uruguay','hash7','1990-08-19'),
...
(5, 'Puedes ver el estado de tu pedido en la sección "Mis Pedidos".'),
(6, '¿Puedo devolver un producto?'),
(7, 'Nuestra política de devoluciones permite devolver productos dentro de los 7 días posteriores a la compra.'),
(8, '¿Cómo puedo contactar al soporte técnico?'),
(8, 'No puedo acceder a mi cuenta.'),
(9, 'No funciona.'),
(10, 'Necesito ayuda con mi compra.');
